...
// OK asserts that the given condition is true.
// If the condition is false, it panics with a formatted error message.
...
// NonNil asserts that the given value is not nil.
// If the value is nil, it panics with a formatted error message.
